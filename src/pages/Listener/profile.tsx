...
import { feedsQuery } from "../../__generated__/feedsQuery";
...
export const ListenerProfile = () => {
  ...
  const { data: feedsResult, loading: feedsLoading } = useQuery<feedsQuery>(
    FEEDS_QUERY
  );
  return useMeLoading || feedsLoading ? (
    ...
    <div className="min-h-screen w-full max-w-screen-md mx-auto flex flex-col bg-blue-300">
      ...
      <div className="flex overflow-auto">
        {useMeResult?.me.subscriptions.map((podcast) => (
      ...
      <div className="flex flex-col w-full my-4">
        {feedsResult?.feeds.episodes?.map((episode) => (
          <EpisodeCard
            key={episode.id}
